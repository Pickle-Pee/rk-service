...
Ant1.prototype.elemPrev = function(num) {
	num = num || 1;
...
Ant1.prototype.elemNext = function(num) {
	num = num || 1;
...
Ant1.prototype.dotOn = function(num) {
	this.indicatorDotsAll[num].style.cssText = 'background-color:#BBB; cursor:pointer;'
};

Ant1.prototype.dotOff = function(num) {
	this.indicatorDotsAll[num].style.cssText = 'background-color:#556; cursor:default;'
};

Ant1.initialize = function(that) {
